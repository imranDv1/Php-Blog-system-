...
<body>
        ...
        <div class="header-inner">
            ...
            <div class="header-right">
                ...
                <a href="user-profile.php?id=<?php echo $user['id']; ?>" class="user-chip">
                    <img src="<?php echo !empty($user['image_url']) ? htmlspecialchars($user['image_url']) : 'https://ui-avatars.com/api/?name='.urlencode($user['name']).'&background=0f0f0f&color=fff'; ?>"
                        alt="">
                    <div>
    ...
    <main>
        ...
        foreach ($cats as $cat):
            ...
            $href = '?cat=' . ($cat === 'All' ? '' : urlencode($cat));
            if ($search !== '') $href .= '&q=' . urlencode($search);
        ?>
            <a href="<?php echo $href; ?>"
                class="cat-pill <?php echo $isActive ? 'active' : ''; ?>"><?php echo $cat; ?></a>
            <?php endforeach; ?>
        </div>
        ...
        <div class="filter-badge">
            ...
            &nbsp;<a href="all-blogs.php" style="color:#7a5200;font-weight:600;text-decoration:none;">✕ Clear</a>
        </div>
        <?php endif; ?>
        ...
        <div class="grid">
            <?php $hasAny = false; while ($post = $result->fetch_assoc()): $hasAny = true; ?>
            <article class="card">
